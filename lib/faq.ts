...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Igen, a vendégek számára az IttFoglalj.hu használata teljesen ingyenes. Nincs regisztrációs díj és nincs foglalási költség sem — ez soha nem is fog változni.",
  },
  {
    question: "Hogyan tudok szolgáltatóként csatlakozni?",
    answer:
      "A csatlakozás egyszerű és néhány lépésben elvégezhető: regisztrálj az IttFoglalj.hu oldalon, hozd létre saját szolgáltatói profilodat, töltsd fel a szolgáltatásaidat, áraidat és referencia munkáidat, majd állítsd be a foglalható időpontjaidat.\n\nA folyamat elindításához kattints a „Szolgáltatóként csatlakozom” gombra, és kövesd az útmutatót.",
  },
  {
